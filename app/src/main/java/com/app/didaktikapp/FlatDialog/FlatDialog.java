package com.app.didaktikapp.FlatDialog;
...
public class FlatDialog extends Dialog {
    ...
    private AutoCompleteTextView first_edit_text;
    ...
    public FlatDialog withTextViewAdapterListener(AdapterView.OnItemClickListener editTextAdapter){
        first_edit_text.setVisibility(View.VISIBLE);
        first_edit_text.setOnItemClickListener(editTextAdapter);
        return this;
    }


    public FlatDialog withTextViewAdapter(ArrayAdapter<Grupo> editTextAdapter){
        first_edit_text.setVisibility(View.VISIBLE);
        first_edit_text.setAdapter(editTextAdapter);
        return this;
    }
