package com.app.didaktikapp.SopaLetras.features.settings;

import android.content.Context;
import android.content.SharedPreferences;

import com.app.didaktikapp.R;
import com.app.didaktikapp.SopaLetras.custom.StreakView;
...
public class Preferences {
    ...
    public Preferences(Context context, SharedPreferences preferences) {
        ...
        KEY_SHOW_GRID_LINE = context.getString(R.string.ZumeltzegiSopaPref_showGridLine);
        KEY_SNAP_TO_GRID = context.getString(R.string.ZumeltzegiSopaPref_snapToGrid);
        KEY_ENABLE_SOUND = context.getString(R.string.ZumeltzegiSopaPref_enableSound);
        KEY_DELETE_AFTER_FINISH = context.getString(R.string.ZumeltzegiSopaPref_deleteAfterFinish);
        KEY_ENABLE_FULLSCREEN = context.getString(R.string.ZumeltzegiSopaPref_enableFullscreen);
        KEY_AUTO_SCALE_GRID = context.getString(R.string.ZumeltzegiSopaPref_autoScaleGrid);
        KEY_REVERSE_MATCHING = context.getString(R.string.ZumeltzegiSopaPref_reverseMatching);
        KEY_GRAYSCALE = context.getString(R.string.ZumeltzegiSopaPref_grayscale);
        DEF_SNAP_TO_GRID = context.getString(R.string.ZumeltzegiSopaSnap_to_grid_def_val);
    }
