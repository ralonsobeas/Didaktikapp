package com.app.didaktikapp.SopaLetras.features.gameover;
...
import com.app.didaktikapp.SopaLetras.model.GameDataInfo;
...
public class GameOverActivity extends FullscreenActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sopa_activity_game_over);
    ...
    public void showGameStat(GameDataInfo info) {
        ...
        String str = getString(R.string.ZumeltzegiSopaFinish_text);
